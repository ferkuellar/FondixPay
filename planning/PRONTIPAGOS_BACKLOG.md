...
|---|---|---|---|---|---|
| PP-001 | CRITICAL | Provider | Obtain Prontipagos sandbox docs. | 8C readiness | pending |
| PP-002 | CRITICAL | Security | Obtain sandbox credentials securely. | 8C readiness | pending |
| PP-003 | HIGH | Provider | Confirm auth mechanism. | 8C | pending |
| PP-004 | HIGH | Catalog | Confirm catalog API. | 8C | pending |
| PP-005 | HIGH | Validation | Confirm reference validation API. | 8C | pending |
| PP-006 | HIGH | Amount | Confirm amount lookup API. | 8C | pending |
| PP-007 | CRITICAL | Payment | Confirm payment execution API. | 8C | pending |
