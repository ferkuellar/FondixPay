...
| CRM-012 | SEV-1 | Support | Support tickets | 10B/10D | backend and frontend minimum implemented |
| CRM-013 | SEV-1 | Manual Review | Manual review queue | 10B/10D | backend and frontend minimum implemented |
| CRM-014 | SEV-1 | Reconciliation | Card reconciliation view | 10B/10D | placeholder backend/frontend implemented |
| CRM-015 | SEV-1 | Reconciliation | Prontipagos reconciliation view | 10B/10D | placeholder backend/frontend implemented |
| CRM-016 | SEV-2 | Search | Provider reference search | 10B | partial |
